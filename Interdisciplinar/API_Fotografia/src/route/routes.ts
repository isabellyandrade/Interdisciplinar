...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/usuario',
            ...(fetchMiddlewares<RequestHandler>(UsuarioController)),
            ...(fetchMiddlewares<RequestHandler>(UsuarioController.prototype.getUsuario)),

            async function UsuarioController_getUsuario(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/imagem',
            ...(fetchMiddlewares<RequestHandler>(ImagemController)),
            ...(fetchMiddlewares<RequestHandler>(ImagemController.prototype.cadastrarImagem)),

            async function ImagemController_cadastrarImagem(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.put('/imagem',
            ...(fetchMiddlewares<RequestHandler>(ImagemController)),
            ...(fetchMiddlewares<RequestHandler>(ImagemController.prototype.atualizarImagem)),

            async function ImagemController_atualizarImagem(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.delete('/imagem',
            ...(fetchMiddlewares<RequestHandler>(ImagemController)),
            ...(fetchMiddlewares<RequestHandler>(ImagemController.prototype.deletarImagem)),

            async function ImagemController_deletarImagem(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    dto: {"in":"body","name":"dto","required":true,"ref":"ImagemDto"},
                    notFound: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    success: {"in":"res","name":"200","required":true,"ref":"BasicResponseDto"},
        ...
        app.get('/imagem',
            ...(fetchMiddlewares<RequestHandler>(ImagemController)),
            ...(fetchMiddlewares<RequestHandler>(ImagemController.prototype.getImagem)),

            async function ImagemController_getImagem(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"query","name":"id","required":true,"dataType":"double"},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/imagem/todos',
            ...(fetchMiddlewares<RequestHandler>(ImagemController)),
            ...(fetchMiddlewares<RequestHandler>(ImagemController.prototype.getImagems)),

            async function ImagemController_getImagems(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    notFound: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    success: {"in":"res","name":"200","required":true,"ref":"BasicResponseDto"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/galeria',
            ...(fetchMiddlewares<RequestHandler>(GaleriaController)),
            ...(fetchMiddlewares<RequestHandler>(GaleriaController.prototype.cadastrarGaleria)),

            async function GaleriaController_cadastrarGaleria(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.put('/galeria',
            ...(fetchMiddlewares<RequestHandler>(GaleriaController)),
            ...(fetchMiddlewares<RequestHandler>(GaleriaController.prototype.atualizarGaleria)),

            async function GaleriaController_atualizarGaleria(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.delete('/galeria',
            ...(fetchMiddlewares<RequestHandler>(GaleriaController)),
            ...(fetchMiddlewares<RequestHandler>(GaleriaController.prototype.deletarGaleria)),

            async function GaleriaController_deletarGaleria(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    dto: {"in":"body","name":"dto","required":true,"ref":"GaleriaDto"},
                    notFound: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    success: {"in":"res","name":"200","required":true,"ref":"BasicResponseDto"},
        ...
        app.get('/galeria',
            ...(fetchMiddlewares<RequestHandler>(GaleriaController)),
            ...(fetchMiddlewares<RequestHandler>(GaleriaController.prototype.getGaleria)),

            async function GaleriaController_getGaleria(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"query","name":"id","required":true,"dataType":"double"},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/galeria/todos',
            ...(fetchMiddlewares<RequestHandler>(GaleriaController)),
            ...(fetchMiddlewares<RequestHandler>(GaleriaController.prototype.getGalerias)),

            async function GaleriaController_getGalerias(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    notFound: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    success: {"in":"res","name":"200","required":true,"ref":"BasicResponseDto"},
            };
